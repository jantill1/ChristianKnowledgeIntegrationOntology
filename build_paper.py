...
def build_doc(r):
    ...
    d.add_heading('Data availability statement',1); para(d,'The prototype ontology, structured passage dataset, validation script, build script, documentation, and machine-readable evaluation results are publicly available under a CC BY 4.0 license at https://github.com/jantill1/ChristianLnowledgeIntegrationOntology.')
